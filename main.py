    ...
    while True:
        ...
        try:
            ...
            if not check_slippage(
                ...
                logging.warning(
                    f"{symbol} Slippage blocked trade."
                )
...
if __name__ == "__main__":
    ...
    try:
        ...
        for symbol in symbols:
            ...
            # Prevents Bitget 429 errors
            # =============================================
            startup_delay = getattr(
                config,
                "PAIR_STARTUP_DELAY",
                10
            )
